...
// POST
// POST has information in it only when it has been submitted to from a form.
// POST is now an array that has values and properties associated with the form inputs that we created in our form. 

// print_p([$_GET,$_POST]);

// header only works if we haven't written anything to the page yet. 
// headers can't be sent if any text has been written to the document, even a space. 
